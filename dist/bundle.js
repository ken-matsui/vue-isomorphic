...
// DBのURL
const URL = 'http://127.0.0.0:3000/data';
...
function getContentsDB() {
	__WEBPACK_IMPORTED_MODULE_0_isomorphic_fetch___default()(URL, {mode:"cors"})
		.then(function(res_) {
			if (res_.status >= 400) {
...
/*
	...
	更新者: 
*/
let compMenu = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
	el: "#menu",
	data: {
		items: []
	}
...
// 上記の代入
for (let i = 0; i < 3; i++) {
	aryCompContents[i] = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
		el: "#comp" + i,
		data: {
			title: "",
			sub: "",
